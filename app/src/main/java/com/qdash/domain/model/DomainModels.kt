...
fun com.qdash.data.local.entities.SalaryDistributionEntity.toDomain() = SalaryDistribution(
    id = id,
    salaryId = salaryId,
    isEnabled = isEnabled,
...
fun SalaryDistribution.toEntity() = com.qdash.data.local.entities.SalaryDistributionEntity(
    id = id,
    salaryId = salaryId,
    isEnabled = isEnabled,
    needsPercentage = needsPercentage,
...
fun com.qdash.data.local.entities.SalaryEnvelopeEntity.toDomain() = SalaryEnvelope(
    id = id,
...
fun SalaryEnvelope.toEntity() = com.qdash.data.local.entities.SalaryEnvelopeEntity(
    id = id,
    distributionId = distributionId,
    type = type.name,
    label = label,
