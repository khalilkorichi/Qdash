...
class NotificationActionReceiver : BroadcastReceiver() {
    companion object {
        const val ACTION_PAUSE = "com.qdash.action.DOWNLOAD_PAUSE"
        const val ACTION_RESUME = "com.qdash.action.DOWNLOAD_RESUME"
        const val ACTION_CANCEL = "com.qdash.action.DOWNLOAD_CANCEL"
