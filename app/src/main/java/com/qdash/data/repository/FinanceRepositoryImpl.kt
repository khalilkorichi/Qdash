...
import com.qdash.domain.usecase.budget.GetBudgetAlertsUseCase
import com.qdash.domain.usecase.budget.GetBudgetGoalsUseCase
...
class IncomeRepositoryImpl(
    ...
    override suspend fun confirmSalaryDelay(
        ...
        com.qdash.core.utils.SystemNotificationHelper.showNotification(
            context = context,
            appNotification = com.qdash.domain.model.AppNotification(
                id = notificationId,
                title = notification.title,
                message = notification.message,
                type = com.qdash.domain.model.NotificationType.SMART_REMINDER,
                isRead = false,
...
class SalaryDistributionRepositoryImpl(
    private val salaryDistributionDao: com.qdash.data.local.dao.SalaryDistributionDao
