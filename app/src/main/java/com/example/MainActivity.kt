...
class MainActivity : ComponentActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val factory = ViewModelFactory(container, this)

        // Read stable prefs once — these do NOT change during navigation
        val sharedPrefs = getSharedPreferences("kdach_prefs", Context.MODE_PRIVATE)
        ...
        com.example.core.utils.FormatterUtils.hideDecimals =
            sharedPrefs.getBoolean("hide_decimals_enabled", false)
 ...
 */
@Composable
private fun FinTrackAppShell(
    container: com.example.core.di.AppContainer,
    factory: com.example.presentation.ViewModelFactory,
    settingsViewModel: SettingsViewModel,
    ...
    CompositionLocalProvider(
        com.example.presentation.navigation.LocalNavController provides navController
    ) {
