    ...
    private fun loadTransactions() {
        ...
        viewModelScope.launch {
            try {
                ...
                ) { baseFilter, calDate, largeOnly, baridiOnly ->
                    Pair(
                        baseFilter.copy(
                ...
                combine(
                    ...
                    val filtered = txs.filter { tx ->
                        ...
                        val matchesCalendarDate = selectedDate == null || (tx.date >= selectedDate && tx.date < selectedDate + 86400000L)
                        ...
                        matchesQuery && matchesCat && matchesAcc && matchesCalendarDate && matchesLarge && matchesBaridi
                    }
